...
import shape_parameters as wing_planform_script

print(wing_planform_script.chord_root)



def find_stringers_for_cross_sections(y_length, n_sections,):
    ...
    chord_length = 0.5  #m
    chord_height = 0.2  #m
    y_position_of_cross_section = 0
    
    step_size_y_direction = y_length/n_sections
    
# =============================================================================
#     for y_position in sp.arange(0, y_length + step_size_y_direction, step_size_y_direction):
# =============================================================================
    ...
    cross_section = {
        "y_position_of_cross_section": y_position_of_cross_section,
        "normal_stress": 0,
        "moment_of_inertia_xx": moment_of_inertia_xx,
        "moment_of_inertia_zz": moment_of_inertia_zz
        }

find_stringers_for_cross_sections(12, 35)