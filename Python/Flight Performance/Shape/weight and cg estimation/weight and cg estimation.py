...
wing_area = 40
g = 9.80665
ratio_from_dylan = wing_area/wing_area_dylan
length_fuselage = ratio_from_dylan * length_fuselage_dylan
def Center_of_Gravity(W_glider,W_tail,W_wing,W_wheels_nose,W_wheels_main,W_fuselage,W_engines):
    #------------------------------------------- COGs --------------------------------------------------------
    ...
    center_of_gravity_ratio = center_of_gravity/length_fuselage
