...
wing_area = 40
g = 9.80665
ratio_from_dylan = np.sqrt(wing_area/wing_area_dylan)
...
W_fuselage = 0.20 * W_glider # Weight of both fuselages combined 
W_engines = 0.16*W_glider 
...
center_of_gravity_fuselage_group = (W_tail*center_of_gravity_tail + W_fuselage*center_of_gravity_fuselage +\
    W_wheels_nose*center_of_gravity_wheels_nose + W_tail*center_of_gravity_tail + W_engines * center_of_gravity_engines) / W_fuselage_group

center_of_gravity_wing_group = (W_wheels_main * center_of_gravity_wheels_main + W_wing*center_of_gravity_wing) / W_wing_group
...
center_of_gravity_percentage = center_of_gravity / length_fuselage